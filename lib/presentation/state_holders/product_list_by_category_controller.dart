...
class ProductListByCategoryController extends GetxController {
  ...
  Future<bool> getProductByCategory(int catrgoryId) async {
    bool isSuccess = false;
    
    _inProgress = true;
    update();
    
    NetworkResponse response = await Get.find<NetworkCaller>().getRequest(url: Urls.productListByCategoryUrl(catrgoryId),);
